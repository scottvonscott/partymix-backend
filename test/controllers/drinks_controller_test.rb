...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { alcoholic: @drink.alcoholic, name: @drink.name, notes: @drink.notes } }, as: :json
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { alcoholic: @drink.alcoholic, name: @drink.name, notes: @drink.notes } }, as: :json
    assert_response 200
  end
